export const metadata = {
  ...
  openGraph: {
    title: "The Memory Heist",
    description: "How I tricked Claude into leaking your deepest, darkest secrets",
    url: "/blog/the-memory-heist",
    images: [
      {
        url: "/blog/the-memory-heist/opengraph-image",
        width: 1200,
        height: 630,
        alt: "The Memory Heist",
      },
    ],
  },
  twitter: {
    ...
    title: "The Memory Heist",
    description: "How I tricked Claude into leaking your deepest, darkest secrets",
    images: ["/blog/the-memory-heist/opengraph-image"],
  },
  date: "2026-06-01",
  updated: "2026-06-01",
  tags: ["memory", "ai"],
...
Anthropic patched this specific vector, but the underlying issue remains. As AI assistants get more capable, they'll possess more and more valuable context, and have even more capabilities outside of the sandbox. The attack worked in this case because three things coincided: persistent valuable memory, autonomous web access, and a model too polite to question a plausible request. This combination is only becoming more common. It won't be the last time it happens.
