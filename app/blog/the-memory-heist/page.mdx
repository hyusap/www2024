export const metadata = {
  ...
  draft: false,
  alternates: {
    canonical: "/blog/the-memory-heist",
  },
  openGraph: {
    type: "article",
    title: "The Memory Heist",
...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      publisher: { "@type": "Person", name: "Ayush Paul" },
      mainEntityOfPage: {
        "@type": "WebPage",
        "@id": "https://ayush.digital/blog/the-memory-heist",
      },
...
<Image
  src={collapsed}
  alt="A Claude conversation that looks innocuous but has silently exfiltrated the user's personal data"
...
<Image
  src={expanded}
  alt="Claude's expanded thinking trace, reasoning out the user's hometown from context before leaking it"
  className="mt-3 rounded-xl"
/>
